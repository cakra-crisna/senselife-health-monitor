...
public class MSBandPlugin extends CordovaPlugin {
  ...
  public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
    ...
    protected void doqueryBandInfo(CallbackContext callbackContext) {
        ...
        try {
            BandInfo[] pairBands = BandClientManager.getInstance().getPairedBands();
            BandInfo bandInfo = pairBands[0];
            String bandName = bandInfo.getName();
            String bandMacAddress = bandInfo.getMacAddress();
            ...
            pendingResult.await();
                ...
                try {
                    ...
                    versionInfo.put("bandName", bandName);
                    versionInfo.put("bandMacAddress", bandMacAddress);
