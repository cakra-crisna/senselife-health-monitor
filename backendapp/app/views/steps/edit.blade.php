...
{{ Form::model($step, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('steps.update', $step->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('steps.show', 'Cancel', $step->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
