...
{{ Form::model($temperature, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('temperatures.update', $temperature->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('temperatures.show', 'Cancel', $temperature->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
