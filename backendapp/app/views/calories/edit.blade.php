...
{{ Form::model($calorie, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('calories.update', $calorie->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('calories.show', 'Cancel', $calorie->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
