    ...
    <div class="row">
        ...
        <div class="col-md-12 ui-sortable">
            ...
            <ul class="nav nav-tabs nav-tabs-inverse nav-justified-mobile" data-sortable-id="index-2">
                <li class="active"><a href="#new-entry" data-toggle="tab"><i class="fa fa-edit m-r-5"></i> <span class="hidden-xs">Update Entry</span></a></li>
            </ul>
            <div class="tab-content" data-sortable-id="index-3">
                <div class="tab-pane fade active in" id="new-entry">
                    ...
                    {{ Form::model($emergency, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('emergencies.update', $emergency->id))) }}
